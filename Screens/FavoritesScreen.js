...
import { View, StyleSheet, Text, ScrollView, TouchableOpacity, Dimensions, ImageBackground } from 'react-native'
        ...
        <View style={styles.container}>
            <ImageBackground source={BackgroundDark} style={{ height: screenHeight, width: screenWidth * 0.9, bottom: 0, left: 0, right: 0, alignContent: 'center' }}>
                <View style={{ alignSelf: 'stretch' }}>
                    ...
                    <Icon style={{ textAlign: 'center', color: 'white' }} size={30} name={'favorite'} />
                    <View style={{ height: 10 }} />
                    <LinearGradient style={{ zIndex: 5, left: 0, right: 0, bottom: -20, position: 'absolute', height: 20 }} colors={['rgba(41, 41, 41, 0.9)', 'rgba(0, 0, 0, 0)']} />
                </View>
                ...
                {/* Close Button */}
                <View style={{ justifyContent: 'center', alignContent: 'center', position: 'absolute', left: 20, top: 20, zIndex: 10, backgroundColor: 'white', height: 30, width: 35, borderRadius: 25 }}>
