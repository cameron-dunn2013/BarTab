    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ justifyContent: 'center', alignSelf: 'stretch', marginTop: 30 }}>
                <Icon size={30} name={'credit-card'} style={{ textAlign: 'center' }} />
                <Text style={{ textAlign: 'center' }}>{'Change Payment Method'}</Text>

                <View style={{ overflow: 'hidden', alignSelf: 'center', marginTop: 20, backgroundColor: 'rgba(0,0,0,0.07)', height: screenHeight * 0.825, width: screenWidth * 0.8, borderRadius: 20 }} >
